      ...
      <div class="_3revO _2mnPN">
        <div class="_3br9T">
          <div>
            ...
            <ul class="_2TxA-">
              <li class="_25Ilv" :class="{_33nt7:key==current_article}" @click.stop="change_article(key)" :title="article.name" v-for="article,key in article_list">
    ...
    export default {
        ...
        data(){
            return {
                ...
                editorTitle:"",        // 当前操作文章的标题
                editorContent:"",      // 当前操作文章的内容
                editorHTMLContent:"",  // 当前操作文章的html内容
        ...
        watch:{
            editorTitle(){
                this.article_list[this.current_article].name=this.editorTitle;
                this.save_article();
            },
            editorContent(){
            ...
            current_article(){
                // 切换文章
                this.is_show_article_menu = false;
                this.editorTitle = this.article_list[this.current_article].name;
        ...
        methods:{
          change_article(key){
              // 切换文章
              clearTimeout(this.timer);
              this.save_article_ajax();
              this.current_article=key;
          },
          save_content(content,html_content){
              // 富文本编辑器内容改变的监听事件
              this.editorContent = content;
              this.editorHTMLContent = html_content;
              this.save_article();
          },
          save_article(){
              // 函数节流
          ...
          save_article_ajax(){
              ...
              this.$axios.put(`${this.$settings.Host}/article/${article_id}/`,{
                  name: this.editorTitle,
                  content: this.editorContent,
                  html_content: this.editorHTMLContent,
              },{
                  headers:{
          ...
          get_article_of_collection(){
              ...
              this.$axios.get(`${this.$settings.Host}/article/collection/article/`,{
                  ...
                  // 切换文集时，把当前选中文章的标题和内容进行切换
                  this.current_article = 0;
                  this.editorTitle = this.article_list[0].name;
                  this.editorContent = this.article_list[0].content;
              }).catch(error=>{
          ...
          add_article(position){
              ...
              this.$axios.post(`${this.$settings.Host}/article/collection/article/`,{
                  ...
                  this.editorTitle = this.get_datetime();
                  this.editorContent = "";
              }).catch(error=>{
          ...
          imgAdd(filename, $fileobj){
              ...
              // <input name="aticle" value="1">
              formdata.append('article', this.article_list[this.current_article].id);
          ...
          imgDel(filename) {
              ...
              // 如果需要通知服务端把，image的is_delete改成false，则可以通过发送ajax完成
          }
        }
    }
</script>
